...
public abstract class DataConstants {
    ...
    // Degree Constants
    protected static final String DEGREE_FILE_NAME = "./src/main/java/data/json/degree.json";
    ...
    // Course Constants
    protected static final String COURSE_FILE_NAME = "./src/main/java/data/json/course.json";
    ...
    // Student Constants
    protected static final String STUDENT_FILE_NAME = "./src/main/java/data/json/student.json";
    ...
    // Advisor Constants
    protected static final String ADVISOR_FILE_NAME = "./src/main/java/data/json/advisor.json";
